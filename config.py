...
class DebateConfig:
    ...
    def from_args(cls):
        ...
        parser.add_argument("--participants", type=int, default=10, help="Number of debate participants")
        parser.add_argument("--iterations", type=int, default=50, help="Maximum number of debate turns")
